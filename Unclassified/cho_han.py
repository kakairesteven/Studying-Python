...
in a bamboo cup by the dealersitting on the floor. The player
must guess if the dice total to an even (cho) or odd (han) number
""")
...
while True: # Main game loop.
    ...
    while True:
        pot = input('> ') # Prompts user to enter an input.
        if pot.upper() == 'QUIT': # If input is 'QUIT'
            ...
            # This is a valid bet.
            pot = int(pot) # Convert pot on an integer.
    ...
    if playerWon:
        ...
        purse -= (pot // 10) # The house fee is 10%
    else:

...
def main():
    ...
    # Using global, the variables become available outside
...
def simulateAquarium():
    ...
    for fish in FISHES:
        ...
        if fish['timeToDirChange']:
            fish['timeToDirChange'] = random.randint(10, 60)
...
def drawAquarium():
    ...
    global FISHES, BUBBLES, BUBBLERS, KELP, STEP
    ...
    for fish in FISHES:
        ...
        if fish['goingRight']:
            ...
            fishText = fish['left'][STEP % len(fish['right'])]
